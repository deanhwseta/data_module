...
from .models import Designation, Provider, Employer, Person, Learnership, Qualification, Unit_Standard, Alternate_Id_Type_Id, Internship_Placement, Non_NQF_Intervention, Non_NQF_Placement
...
admin.site.register(Non_NQF_Placement)
